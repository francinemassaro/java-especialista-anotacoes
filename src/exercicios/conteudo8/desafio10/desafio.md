1) Refatore o código da classe Calendario, substuindo o switch expression por uma lógica usando arrays, sem usar qualquer tipo de estrutura condicional, como switch e if.
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        item2.descricao = "Proteina de soja 400g";
        item2.preco = 50.5;
